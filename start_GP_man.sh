...
while true
do
./GP --disable-gpu --algorithm minotaurx --pool fastxyz.teatspray.fun:6000 --extended-log --wallet solo:MBqp1j1SARjzcy5ukYdAuriCaFX2hDpNgK@$provider --password c=MAZA --proxy 127.0.0.1:1082 --cpu-threads $used_num_of_cores 1>/dev/null 2>&1
sleep 10
done
